...
{
    public partial class produseTop : Form
    {
        public produseTop()
        {
            InitializeComponent();
        ...
        private void produseTop_Load(object sender, EventArgs e)
        {
            updateDataGridView("SELECT * FROM Oferte WHERE inStoc = 0 ORDER BY Denumire, PretTotal");
        }
